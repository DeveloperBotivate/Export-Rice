...
export const FinalQC = () => {
  const getInitialData = () => {
    const rawPending = JSON.parse(localStorage.getItem('production_11_history')) || [];
    const rawHistory = JSON.parse(localStorage.getItem('production_12_history')) || [];
  ...
  const handleSave = () => {
    ...
    if (!rawHistory.includes(processedItem.id)) {
      ...
      localStorage.setItem('production_12_history', JSON.stringify(rawHistory));
    }
