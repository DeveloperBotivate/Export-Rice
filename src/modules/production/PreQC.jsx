...
export const PreQC = () => {
  const getInitialData = () => {
    const rawPending = JSON.parse(localStorage.getItem('production_4_history')) || [];
    const rawHistory = JSON.parse(localStorage.getItem('production_5_history')) || [];
  ...
  const handleSave = () => {
    ...
    if (!rawHistory.includes(processedItem.id)) {
      ...
      localStorage.setItem('production_5_history', JSON.stringify(rawHistory));
    }
