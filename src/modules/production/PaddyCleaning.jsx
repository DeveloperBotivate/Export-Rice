...
export const PaddyCleaning = () => {
  const getInitialData = () => {
    const rawPending = JSON.parse(localStorage.getItem('production_5_history')) || [];
    const rawHistory = JSON.parse(localStorage.getItem('production_6_history')) || [];
  ...
  const handleSave = () => {
    ...
    if (!rawHistory.includes(processedItem.id)) {
      ...
      localStorage.setItem('production_6_history', JSON.stringify(rawHistory));
    }
