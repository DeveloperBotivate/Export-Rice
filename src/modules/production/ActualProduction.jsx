...
export const ActualProduction = () => {
  ...
  const pendingCols = [{"header":"Production Order No","accessor":"productionOrderNo"},{"header":"Plan Date","accessor":"planDate"},{"header":"Paddy Grade","accessor":"paddyGrade"},{"header":"Planned Input Qty (MT)","accessor":"plannedInputQty"},{"header":"Expected Recovery %","accessor":"recoveryTarget"},{"header":"Machine Assigned","accessor":"machineAssigned"},{"header":"Shift","accessor":"shift"}];
  const historyCols = [{"header":"Production Order No","accessor":"productionOrderNo"},{"header":"Paddy Grade","accessor":"paddyGrade"},{"header":"Planned Qty (MT)","accessor":"plannedInputQty"},{"header":"Actual Start Date","accessor":"actualStartDate"},{"header":"Actual Start Time","accessor":"actualStartTime"},{"header":"Machine ID","accessor":"machineAssigned"},{"header":"Operator Name","accessor":"operatorAssigned"},{"header":"Shift","accessor":"shift"},{"header":"Status","accessor":"status"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 2 - Actual Production</h2>
      </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input 
                ...
                onChange={(e) => setFormData({...formData, machineAssigned: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
