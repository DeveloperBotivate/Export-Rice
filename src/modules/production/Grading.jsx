...
export const Grading = () => {
  const getInitialData = () => {
    const rawPending = JSON.parse(localStorage.getItem('production_9_history')) || [];
    const rawHistory = JSON.parse(localStorage.getItem('production_10_history')) || [];
  ...
  const handleSave = () => {
    ...
    if (!rawHistory.includes(processedItem.id)) {
      ...
      localStorage.setItem('production_10_history', JSON.stringify(rawHistory));
    }
