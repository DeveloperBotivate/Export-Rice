...
export const ProductionOrder = () => {
  const getInitialData = () => {
    const rawPending = JSON.parse(localStorage.getItem('production_1_history')) || [];
    const rawHistory = JSON.parse(localStorage.getItem('production_2_history')) || [];
  ...
  const handleSave = () => {
    ...
    if (!rawHistory.includes(processedItem.id)) {
      ...
      localStorage.setItem('production_2_history', JSON.stringify(rawHistory));
    }
