...
export const ProductionOrder = () => {
  const getInitialData = () => {
    let rawPending = JSON.parse(localStorage.getItem('prod_v3_1_history')) || [];
    let rawHistory = JSON.parse(localStorage.getItem('prod_v3_2_history')) || [];
    ...
    if (!master || master.length === 0) {
      ...
      rawPending = JSON.parse(localStorage.getItem('prod_v3_1_history')) || [];
      rawHistory = JSON.parse(localStorage.getItem('prod_v3_2_history')) || [];
    }
  ...
  const handleSave = () => {
    ...
    const rawHistory = JSON.parse(localStorage.getItem('prod_v3_2_history')) || [];
    if (!rawHistory.includes(processedItem.id)) {
      rawHistory.unshift(processedItem.id);
      localStorage.setItem('prod_v3_2_history', JSON.stringify(rawHistory));
    }
