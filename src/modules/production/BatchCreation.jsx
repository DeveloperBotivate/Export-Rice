...
export const BatchCreation = () => {
  const getInitialData = () => {
    const rawPending = JSON.parse(localStorage.getItem('production_2_history')) || [];
    const rawHistory = JSON.parse(localStorage.getItem('production_3_history')) || [];
  ...
  const handleSave = () => {
    ...
    if (!rawHistory.includes(processedItem.id)) {
      ...
      localStorage.setItem('production_3_history', JSON.stringify(rawHistory));
    }
