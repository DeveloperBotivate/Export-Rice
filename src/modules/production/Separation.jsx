...
export const Separation = () => {
  const getInitialData = () => {
    const rawPending = JSON.parse(localStorage.getItem('production_7_history')) || [];
    const rawHistory = JSON.parse(localStorage.getItem('production_8_history')) || [];
  ...
  const handleSave = () => {
    ...
    if (!rawHistory.includes(processedItem.id)) {
      ...
      localStorage.setItem('production_8_history', JSON.stringify(rawHistory));
    }
