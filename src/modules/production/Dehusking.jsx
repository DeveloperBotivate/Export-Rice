...
export const Dehusking = () => {
  const getInitialData = () => {
    let rawPending = JSON.parse(localStorage.getItem('prod_v3_6_history')) || [];
    let rawHistory = JSON.parse(localStorage.getItem('prod_v3_7_history')) || [];
    ...
    if (!master || master.length === 0) {
      ...
      rawPending = JSON.parse(localStorage.getItem('prod_v3_6_history')) || [];
      rawHistory = JSON.parse(localStorage.getItem('prod_v3_7_history')) || [];
    }
  ...
  const handleSave = () => {
    ...
    const rawHistory = JSON.parse(localStorage.getItem('prod_v3_7_history')) || [];
    if (!rawHistory.includes(processedItem.id)) {
      rawHistory.unshift(processedItem.id);
      localStorage.setItem('prod_v3_7_history', JSON.stringify(rawHistory));
    }
