...
export const Dehusking = () => {
  const getInitialData = () => {
    const rawPending = JSON.parse(localStorage.getItem('production_6_history')) || [];
    const rawHistory = JSON.parse(localStorage.getItem('production_7_history')) || [];
  ...
  const handleSave = () => {
    ...
    if (!rawHistory.includes(processedItem.id)) {
      ...
      localStorage.setItem('production_7_history', JSON.stringify(rawHistory));
    }
