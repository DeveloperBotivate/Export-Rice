...
export const FGWarehouseEntry = () => {
  const getInitialData = () => {
    const rawPending = JSON.parse(localStorage.getItem('production_15_history')) || [];
    const rawHistory = JSON.parse(localStorage.getItem('production_16_history')) || [];
  ...
  const handleSave = () => {
    ...
    if (!rawHistory.includes(processedItem.id)) {
      ...
      localStorage.setItem('production_16_history', JSON.stringify(rawHistory));
    }
