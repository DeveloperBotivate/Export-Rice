...
export const RawMaterialIssue = () => {
  const getInitialData = () => {
    const rawPending = JSON.parse(localStorage.getItem('production_3_history')) || [];
    const rawHistory = JSON.parse(localStorage.getItem('production_4_history')) || [];
  ...
  const handleSave = () => {
    ...
    if (!rawHistory.includes(processedItem.id)) {
      ...
      localStorage.setItem('production_4_history', JSON.stringify(rawHistory));
    }
