...
export const YieldCalculation = () => {
  const getInitialData = () => {
    const rawPending = JSON.parse(localStorage.getItem('production_12_history')) || [];
    const rawHistory = JSON.parse(localStorage.getItem('production_13_history')) || [];
  ...
  const handleSave = () => {
    ...
    if (!rawHistory.includes(processedItem.id)) {
      ...
      localStorage.setItem('production_13_history', JSON.stringify(rawHistory));
    }
