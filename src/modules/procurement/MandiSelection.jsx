...
export const MandiSelection = () => {
  ...
  const pendingCols = [{"header":"Procurement ID","accessor":"procurementId"},{"header":"Paddy Type","accessor":"paddyType"},{"header":"Procurement Region","accessor":"procurementRegion"},{"header":"Expected Qty (MT)","accessor":"expectedQty"},{"header":"Approved Budget (₹)","accessor":"approvedBudget"},{"header":"Approval Date","accessor":"approvalDate"}];
  const historyCols = [{"header":"Procurement ID","accessor":"procurementId"},{"header":"Mandi Name","accessor":"mandiName"},{"header":"Mandi Location","accessor":"mandiLocation"},{"header":"Mandi Type","accessor":"mandiType"},{"header":"Distance (km)","accessor":"distance"},{"header":"Contact Person","accessor":"contactPerson"},{"header":"Selected By","accessor":"selectedBy"},{"header":"Selection Date","accessor":"selectionDate"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 3 - Mandi Selection</h2>
      </div>
        ...
        <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Select 
                value={formData.mandiType || ''} 
                onChange={(e) => setFormData({...formData, mandiType: e.target.value})}
                disabled={false}
                className={false ? 'bg-slate-100' : ''}
              >
                <option value="">Select Mandi Type</option>
                <option value="APMC">APMC</option><option value="Private">Private</option>
              </Select>
            </div>
            <div className="space-y-1.5">
              <Label>Distance from Mill (km)</Label>
              <Input 
                type="number"
            ...
            <div className="space-y-1.5">
              ...
              <Input 
                ...
                onChange={(e) => setFormData({...formData, selectedBy: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
