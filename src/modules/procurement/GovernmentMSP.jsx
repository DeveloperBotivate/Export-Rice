...
export const GovernmentMSP = () => {
  ...
  const handleActionClick = (item) => {
    ...
    const readOnlyFields = ["procurementId","paddyType"];
  ...
  const pendingCols = [{"header":"Procurement ID","accessor":"procurementId"},{"header":"Mandi Name","accessor":"mandiName"},{"header":"Paddy Type","accessor":"paddyType"},{"header":"Market Price (₹/Qt)","accessor":"marketPrice"},{"header":"Price Date","accessor":"priceDate"}];
  const historyCols = [{"header":"Procurement ID","accessor":"procurementId"},{"header":"Mandi Name","accessor":"mandiName"},{"header":"Paddy Type","accessor":"paddyType"},{"header":"MSP Rate (₹/Qt)","accessor":"mspRate"},{"header":"Market Price (₹/Qt)","accessor":"marketPrice"},{"header":"Paddy Grade","accessor":"paddyGrade"},{"header":"MSP Year","accessor":"mspYear"},{"header":"Declared By","accessor":"declaredBy"},{"header":"Effective Date","accessor":"effectiveDate"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 5 - Government MSP</h2>
      </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input 
                ...
                onChange={(e) => setFormData({...formData, paddyType: e.target.value})}
                readOnly={true}
                className={true ? 'bg-slate-100' : ''}
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Select 
                ...
                className={false ? 'bg-slate-100' : ''}
              >
                <option value="">Select Paddy Grade</option>
                <option value="A">A</option><option value="B">B</option><option value="C">C</option>
              </Select>
            </div>
            <div className="space-y-1.5">
              <Label>MSP Year</Label>
              <Input 
                type="text"
                value={formData.mspYear || ''} 
                onChange={(e) => setFormData({...formData, mspYear: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
