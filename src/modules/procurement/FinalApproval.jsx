...
export const FinalApproval = () => {
  ...
  const pendingCols = [{"header":"Procurement ID","accessor":"procurementId"},{"header":"Mandi Name","accessor":"mandiName"},{"header":"Paddy Type","accessor":"paddyType"},{"header":"MSP Rate (₹/Qt)","accessor":"mspRate"},{"header":"Market Price (₹/Qt)","accessor":"marketPrice"},{"header":"Lab Grade","accessor":"finalLabGrade"}];
  const historyCols = [{"header":"Procurement ID","accessor":"procurementId"},{"header":"Mandi Name","accessor":"mandiName"},{"header":"Paddy Type","accessor":"paddyType"},{"header":"Final Purchase Rate (₹/Qt)","accessor":"finalPurchaseRate"},{"header":"Approved Qty (MT)","accessor":"approvedQty"},{"header":"Payment Terms","accessor":"paymentTerms"},{"header":"Advance Amount (₹)","accessor":"advanceAmount"},{"header":"Approval Authority","accessor":"approvalAuthority"},{"header":"Approval Date","accessor":"approvalDate"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 7 - Final Approval</h2>
      </div>
