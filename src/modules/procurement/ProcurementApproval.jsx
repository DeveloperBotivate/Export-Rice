...
export const ProcurementApproval = () => {
  ...
  const pendingCols = [{"header":"Procurement ID","accessor":"procurementId"},{"header":"Planning Date","accessor":"planningDate"},{"header":"Paddy Type","accessor":"paddyType"},{"header":"Expected Qty (MT)","accessor":"expectedQty"},{"header":"Budget Allocated (₹)","accessor":"budgetAllocated"},{"header":"Planned By","accessor":"plannedBy"}];
  const historyCols = [{"header":"Procurement ID","accessor":"procurementId"},{"header":"Paddy Type","accessor":"paddyType"},{"header":"Expected Qty (MT)","accessor":"expectedQty"},{"header":"Approved Budget (₹)","accessor":"approvedBudget"},{"header":"Approval Date","accessor":"approvalDate"},{"header":"Approved By","accessor":"approvedBy"},{"header":"Priority Level","accessor":"priorityLevel"},{"header":"Approval Status","accessor":"approvalStatus"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 2 - Procurement Approval</h2>
      </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              >
                ...
                <option value="Approved">Approved</option><option value="Rejected">Rejected</option><option value="Hold">Hold</option>
              </Select>
            </div>
          </div>
