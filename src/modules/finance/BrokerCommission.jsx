...
export const BrokerCommission = () => {
  ...
  const handleActionClick = (item) => {
    ...
    autoFields = { bcId: 'BC-' + Math.floor(Math.random()*10000) };
    
    
    
    
    
    const readOnlyFields = ["contractNo","bcId","contractValueUsd","commissionUsd","inrEquivalent","netPayable"];
  ...
  const pendingCols = [{"header":"Contract No","accessor":"contractNo"},{"header":"Contract Date","accessor":"contractDate"},{"header":"Buyer Name","accessor":"buyerName"},{"header":"Buyer Country","accessor":"buyerCountry"},{"header":"Rice Grade","accessor":"riceGrade"},{"header":"Quantity (MT)","accessor":"quantity"},{"header":"Total Contract Value ($)","accessor":"contractValueUsd"},{"header":"Payment Terms","accessor":"paymentTerms"}];
  const historyCols = [{"header":"Broker Commission ID","accessor":"bcId"},{"header":"Contract No","accessor":"contractNo"},{"header":"Buyer Name","accessor":"buyerName"},{"header":"Broker Name","accessor":"brokerName"},{"header":"Commission Type","accessor":"commissionType"},{"header":"Commission Amount ($)","accessor":"commissionUsd"},{"header":"INR Equivalent (₹)","accessor":"inrEquivalent"},{"header":"TDS (₹)","accessor":"tdsAmount"},{"header":"Net Payable (₹)","accessor":"netPayable"},{"header":"Payment Date","accessor":"paymentDate"},{"header":"SWIFT/UTR Ref","accessor":"swiftRef"}];
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-slate-800">Stage 8 - Broker Commission</h2>
