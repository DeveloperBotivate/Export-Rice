...
export const AccountsPayable = () => {
  ...
  const handleActionClick = (item) => {
    ...
    let autoFields = {};
    autoFields = { apId: 'AP-' + Math.floor(Math.random()*10000) };
    ...
    const readOnlyFields = ["closureId","poNumber","prNumber","apId","vendorName","tdsAmount","netPayable","outstanding"];
  ...
  const pendingCols = [{"header":"Purchase Closure ID","accessor":"closureId"},{"header":"PR Number","accessor":"prNumber"},{"header":"PO Number","accessor":"poNumber"},{"header":"Vendor/Farmer Name","accessor":"vendorName"},{"header":"Net Qty (MT)","accessor":"netQty"},{"header":"Final Purchase Rate (₹/Qt)","accessor":"purchaseRate"},{"header":"Total Purchase Value (₹)","accessor":"purchaseValue"},{"header":"Closure Date","accessor":"closureDate"}];
  const historyCols = [{"header":"AP ID","accessor":"apId"},{"header":"Purchase Closure ID","accessor":"closureId"},{"header":"PO Number","accessor":"poNumber"},{"header":"PR Number","accessor":"prNumber"},{"header":"Vendor Name","accessor":"vendorName"},{"header":"Bill No","accessor":"billNo"},{"header":"Bill Date","accessor":"billDate"},{"header":"Bill Amount (₹)","accessor":"billAmount"},{"header":"TDS (₹)","accessor":"tdsAmount"},{"header":"Net Payable (₹)","accessor":"netPayable"},{"header":"Due Date","accessor":"dueDate"},{"header":"Amount Paid (₹)","accessor":"amountPaid"},{"header":"Outstanding (₹)","accessor":"outstanding"},{"header":"Status","accessor":"paymentStatus"}];
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-slate-800">Stage 2 - Accounts Payable</h2>
        ...
        <div className="max-h-[85vh] overflow-y-auto">
          <div className="bg-gradient-to-r from-green-900 to-green-800 px-6 py-4 flex items-center justify-between">
            <div>
              ...
              <h3 className="text-white text-lg font-bold mt-0.5">AP Details</h3>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
              ...
              <div className={'p-3 rounded-xl border border-slate-200 bg-slate-50/70 space-y-1.5'}>
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Purchase Closure ID</Label>
              ...
              <div className={'p-3 rounded-xl border border-slate-200 bg-white shadow-sm hover:shadow-md hover:border-green-300 transition-all space-y-1.5'}>
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Vendor Phone</Label>
              ...
              <div className={'p-3 rounded-xl border border-slate-200 bg-white shadow-sm hover:shadow-md hover:border-green-300 transition-all space-y-1.5'}>
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Bill Date</Label>
              ...
              <div className={'p-3 rounded-xl border border-slate-200 bg-white shadow-sm hover:shadow-md hover:border-green-300 transition-all space-y-1.5'}>
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Bill Amount (₹)</Label>
              ...
              <div className={'p-3 rounded-xl border border-slate-200 bg-slate-50/70 space-y-1.5'}>
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-semibold text-slate-500 uppercase tracking-wide">TDS Amount (₹)</Label>
                  <span className="text-[10px] bg-slate-200 text-slate-500 px-1.5 py-0.5 rounded font-medium">AUTO</span>
                </div>
                <Input 
                  type="number"
