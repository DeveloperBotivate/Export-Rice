...
export const TransporterPayments = () => {
  ...
  const handleActionClick = (item) => {
    ...
    autoFields = { paymentId: 'TP-' + Math.floor(Math.random()*10000) };
    ...
    const readOnlyFields = ["loadingId","dispatchOrderNo","transporterName","transporterGst","paymentId","tripRef","freightAmount","balancePayable","tdsAmount","netPayable"];
  ...
  const pendingCols = [{"header":"Loading ID","accessor":"loadingId"},{"header":"Dispatch Order No","accessor":"dispatchOrderNo"},{"header":"Vehicle Number","accessor":"vehicleNumber"},{"header":"Transporter Name","accessor":"transporterName"},{"header":"Transporter GSTIN","accessor":"transporterGst"},{"header":"Route","accessor":"route"},{"header":"Total Loaded Weight (MT)","accessor":"weightLoaded"},{"header":"Freight Rate (₹/MT)","accessor":"freightRate"},{"header":"Total Freight (₹)","accessor":"totalFreight"},{"header":"Expected Delivery Date","accessor":"expectedDelivery"}];
  const historyCols = [{"header":"Payment ID","accessor":"paymentId"},{"header":"Loading ID","accessor":"loadingId"},{"header":"Dispatch Order No","accessor":"dispatchOrderNo"},{"header":"Transporter Name","accessor":"transporterName"},{"header":"Trip Ref","accessor":"tripRef"},{"header":"Freight Amount (₹)","accessor":"freightAmount"},{"header":"Advance Paid (₹)","accessor":"advancePaid"},{"header":"TDS (₹)","accessor":"tdsAmount"},{"header":"Net Payable (₹)","accessor":"netPayable"},{"header":"Payment Mode","accessor":"paymentMode"},{"header":"UTR/Cheque No","accessor":"utrNo"},{"header":"Payment Date","accessor":"paymentDate"},{"header":"Paid By","accessor":"paidBy"}];
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-slate-800">Stage 4 - Transporter Payments</h2>
      ...
      <Modal 
        ...
        title="Transporter Payment Details"
        size="5xl"
      >
        <div className="max-h-[85vh] overflow-y-auto">
          <div className="bg-gradient-to-r from-green-900 to-green-800 px-6 py-4 flex items-center justify-between">
            <div>
              ...
              <h3 className="text-white text-lg font-bold mt-0.5">Transporter Payment Details</h3>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
              ...
              <div className={'p-3 rounded-xl border border-slate-200 bg-slate-50/70 space-y-1.5'}>
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Loading ID</Label>
              ...
              <div className={'p-3 rounded-xl border border-slate-200 bg-slate-50/70 space-y-1.5'}>
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Transporter Name</Label>
                  <span className="text-[10px] bg-slate-200 text-slate-500 px-1.5 py-0.5 rounded font-medium">AUTO</span>
                </div>
                <Input 
                  type="text"
              ...
              <div className={'p-3 rounded-xl border border-slate-200 bg-slate-50/70 space-y-1.5'}>
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Transporter GSTIN</Label>
                  <span className="text-[10px] bg-slate-200 text-slate-500 px-1.5 py-0.5 rounded font-medium">AUTO</span>
                </div>
                <Input 
                  type="text"
              ...
              <div className={'p-3 rounded-xl border border-slate-200 bg-slate-50/70 space-y-1.5'}>
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Trip Reference</Label>
                  <span className="text-[10px] bg-slate-200 text-slate-500 px-1.5 py-0.5 rounded font-medium">AUTO</span>
                </div>
                <Input 
                  type="text"
                  value={formData.tripRef || ''} 
                  onChange={(e) => setFormData({...formData, tripRef: e.target.value})}
                  readOnly={true}
                  className={'bg-slate-100 text-slate-500 border-slate-200 cursor-not-allowed text-sm'}
                  placeholder=""
                />
              ...
              <div className={'p-3 rounded-xl border border-slate-200 bg-slate-50/70 space-y-1.5'}>
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Freight Amount (₹)</Label>
                  <span className="text-[10px] bg-slate-200 text-slate-500 px-1.5 py-0.5 rounded font-medium">AUTO</span>
                </div>
                <Input 
                  type="number"
              ...
              <div className={'p-3 rounded-xl border border-slate-200 bg-white shadow-sm hover:shadow-md hover:border-green-300 transition-all space-y-1.5'}>
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Advance Already Paid (₹)</Label>
              ...
              <div className={'p-3 rounded-xl border border-slate-200 bg-slate-50/70 space-y-1.5'}>
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Balance Payable (₹)</Label>
                  <span className="text-[10px] bg-slate-200 text-slate-500 px-1.5 py-0.5 rounded font-medium">AUTO</span>
                </div>
                <Input 
                  type="number"
