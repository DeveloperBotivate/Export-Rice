...
export const Barcode = () => {
  ...
  const handleActionClick = (item) => {
    ...
    const readOnlyFields = ["packingOrderNo","totalBarcodes"];
  ...
  const pendingCols = [{"header":"Packing Order No","accessor":"packingOrderNo"},{"header":"Rice Grade","accessor":"riceGrade"},{"header":"Bag Type","accessor":"bagType"},{"header":"Bag Size","accessor":"bagSize"},{"header":"No. of Bags Required","accessor":"noOfBagsRequired"},{"header":"Packing Material Batch No","accessor":"packingMaterialBatchNo"},{"header":"Approved By","accessor":"approvedBy"}];
  const historyCols = [{"header":"Packing Order No","accessor":"packingOrderNo"},{"header":"Barcode Format","accessor":"barcodeFormat"},{"header":"Barcode Series (From–To)","accessor":"barcodeSeries"},{"header":"Total Barcodes","accessor":"totalBarcodes"},{"header":"Print Date","accessor":"printDate"},{"header":"Printed By","accessor":"printedBy"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 3 - Barcode Generation</h2>
      </div>
      ...
      >
        <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label>Barcode Series Start</Label>
              <Input 
                type="number"
            ...
            <div className="space-y-1.5">
              <Label>Barcode Series End</Label>
              <Input 
                type="number"
            ...
            <div className="space-y-1.5">
              ...
              <Input 
                type="number"
                value={formData.totalBarcodes || ''} 
                onChange={(e) => setFormData({...formData, totalBarcodes: e.target.value})}
                readOnly={true}
                className={true ? 'bg-slate-100' : ''}
              />
            </div>
            <div className="space-y-1.5">
              ...
              <Input 
                ...
                onChange={(e) => setFormData({...formData, printedBy: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
