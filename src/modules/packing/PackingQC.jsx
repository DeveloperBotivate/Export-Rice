...
export const PackingQC = () => {
  ...
  const handleActionClick = (item) => {
    ...
    autoFields = { qcId: 'QC-' + Math.floor(Math.random()*10000) };
    
    
    const readOnlyFields = ["weightVerifyId","newLotNumber","packingOrderNo","qcId"];
  ...
  const pendingCols = [{"header":"Weight Verify ID","accessor":"weightVerifyId"},{"header":"Lot Number","accessor":"newLotNumber"},{"header":"Batch Number","accessor":"newBatchNumber"},{"header":"Packing Order No","accessor":"packingOrderNo"},{"header":"Rice Grade","accessor":"riceGrade"},{"header":"Avg Weight (Kg)","accessor":"avgWeight"},{"header":"Variance %","accessor":"variance"},{"header":"Pass / Fail (Weight)","accessor":"weightPassFail"}];
  const historyCols = [{"header":"QC ID","accessor":"qcId"},{"header":"Weight Verify ID","accessor":"weightVerifyId"},{"header":"Lot Number","accessor":"newLotNumber"},{"header":"Packing Order No","accessor":"packingOrderNo"},{"header":"Seal Check","accessor":"sealIntegrity"},{"header":"Label Check","accessor":"labelAccuracy"},{"header":"Bag Stitching","accessor":"bagStitching"},{"header":"Visual Check","accessor":"visualAppearance"},{"header":"Sample Size","accessor":"qcSampleSize"},{"header":"Rejection Count","accessor":"rejectionCount"},{"header":"QC Result","accessor":"qcResult"},{"header":"QC Date","accessor":"qcDate"},{"header":"QC Inspector","accessor":"qcInspector"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 8 - Packing QC</h2>
      </div>
        ...
        <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Select 
                value={formData.sealIntegrity || ''} 
                onChange={(e) => setFormData({...formData, sealIntegrity: e.target.value})}
                disabled={false}
                className={false ? 'bg-slate-100' : ''}
              >
                <option value="">Select Seal Integrity</option>
            ...
            <div className="space-y-1.5">
              ...
              <Select 
                ...
                onChange={(e) => setFormData({...formData, labelPlacement: e.target.value})}
                disabled={false}
                className={false ? 'bg-slate-100' : ''}
              >
                <option value="">Select Label Placement</option>
                <option value="Pass">Pass</option><option value="Fail">Fail</option>
              </Select>
            </div>
            <div className="space-y-1.5">
              ...
              <Select 
                value={formData.labelAccuracy || ''} 
                onChange={(e) => setFormData({...formData, labelAccuracy: e.target.value})}
                disabled={false}
                className={false ? 'bg-slate-100' : ''}
              >
                <option value="">Select Label Accuracy</option>
                <option value="Pass">Pass</option><option value="Fail">Fail</option>
              </Select>
            </div>
            <div className="space-y-1.5">
              <Label>Bag Stitching</Label>
              <Select 
                value={formData.bagStitching || ''} 
                onChange={(e) => setFormData({...formData, bagStitching: e.target.value})}
                disabled={false}
                className={false ? 'bg-slate-100' : ''}
              >
                <option value="">Select Bag Stitching</option>
                <option value="Pass">Pass</option><option value="Fail">Fail</option>
              </Select>
            </div>
            <div className="space-y-1.5">
              ...
              <Input 
                ...
                onChange={(e) => setFormData({...formData, visualAppearance: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
            <div className="space-y-1.5">
              ...
              <Input 
                type="number"
                value={formData.qcSampleSize || ''} 
                onChange={(e) => setFormData({...formData, qcSampleSize: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
            <div className="space-y-1.5">
              ...
              <Input 
                ...
                onChange={(e) => setFormData({...formData, rejectionCount: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
