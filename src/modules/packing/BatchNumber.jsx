...
export const BatchNumber = () => {
  ...
  const handleActionClick = (item) => {
    ...
    autoFields = { newBatchNumber: 'BT-' + Math.floor(Math.random()*10000) };
    
    
    
    
    
    const readOnlyFields = ["packingOrderNo","qrBatchId","newBatchNumber","riceGrade","lotNo"];
  ...
  const pendingCols = [{"header":"Packing Order No","accessor":"packingOrderNo"},{"header":"QR Batch ID","accessor":"qrBatchId"},{"header":"Rice Grade","accessor":"riceGrade"},{"header":"Lot No","accessor":"lotNo"},{"header":"Total QR Generated","accessor":"totalQrGenerated"},{"header":"Packed Date","accessor":"packedDate"}];
  const historyCols = [{"header":"Batch Number","accessor":"newBatchNumber"},{"header":"Packing Order No","accessor":"packingOrderNo"},{"header":"QR Batch ID","accessor":"qrBatchId"},{"header":"Batch Date","accessor":"batchDate"},{"header":"Rice Grade","accessor":"riceGrade"},{"header":"Lot No","accessor":"lotNo"},{"header":"Qty in Batch (MT)","accessor":"qtyInBatch"},{"header":"Manufacturing Date","accessor":"manufacturingDate"},{"header":"Best Before Date","accessor":"bestBeforeDate"},{"header":"Assigned By","accessor":"assignedBy"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 5 - Batch Number Assignment</h2>
      </div>
      ...
      >
        <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label>Input Production Order No</Label>
              <Input 
                type="text"
                value={formData.inputProductionOrderNo || ''} 
                onChange={(e) => setFormData({...formData, inputProductionOrderNo: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
            <div className="space-y-1.5">
              <Label>Quantity in Batch (MT)</Label>
              <Input 
                type="number"
                value={formData.qtyInBatch || ''} 
                onChange={(e) => setFormData({...formData, qtyInBatch: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
