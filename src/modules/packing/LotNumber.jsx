...
export const LotNumber = () => {
  ...
  const handleActionClick = (item) => {
    ...
    autoFields = { newLotNumber: 'LT-' + Math.floor(Math.random()*10000), linkedBatchNo: item.newBatchNumber };
    
    
    
    
    const readOnlyFields = ["newBatchNumber","packingOrderNo","newLotNumber","linkedBatchNo"];
  ...
  const pendingCols = [{"header":"Batch Number","accessor":"newBatchNumber"},{"header":"Packing Order No","accessor":"packingOrderNo"},{"header":"Rice Grade","accessor":"riceGrade"},{"header":"Lot No","accessor":"lotNo"},{"header":"Qty in Batch (MT)","accessor":"qtyInBatch"},{"header":"Manufacturing Date","accessor":"manufacturingDate"},{"header":"Best Before Date","accessor":"bestBeforeDate"}];
  const historyCols = [{"header":"Lot Number","accessor":"newLotNumber"},{"header":"Batch Number","accessor":"newBatchNumber"},{"header":"Packing Order No","accessor":"packingOrderNo"},{"header":"Rice Grade","accessor":"riceGrade"},{"header":"Lot Qty (MT)","accessor":"lotQuantity"},{"header":"Warehouse","accessor":"warehouse"},{"header":"Go-down","accessor":"godown"},{"header":"Rack / Bin","accessor":"rackBin"},{"header":"Assigned Date","accessor":"assignedDate"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 6 - Lot Number Assignment</h2>
      </div>
      ...
      >
        <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label>Linked Batch No</Label>
              <Input 
                type="text"
                value={formData.linkedBatchNo || ''} 
                onChange={(e) => setFormData({...formData, linkedBatchNo: e.target.value})}
                readOnly={true}
                className={true ? 'bg-slate-100' : ''}
              />
            </div>
            <div className="space-y-1.5">
              <Label>Lot Quantity (MT)</Label>
              <Input 
                type="number"
