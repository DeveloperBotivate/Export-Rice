...
export const ExportPayment = () => {
  ...
  const handleActionClick = (item) => {
    ...
    autoFields = { paymentId: 'EP-' + Math.floor(Math.random()*10000) };
  ...
  const pendingCols = [{"header":"Export Invoice No","accessor":"exportInvoiceNo"},{"header":"Contract No","accessor":"contractNo"},{"header":"Buyer Name","accessor":"buyerName"},{"header":"Buyer Country","accessor":"buyerCountry"},{"header":"Invoice Amount ($)","accessor":"invoiceAmount"},{"header":"Invoice Date","accessor":"invoiceDate"},{"header":"Bank Ref No","accessor":"bankRefNo"},{"header":"LC No","accessor":"lcNo"},{"header":"Doc Submission Date","accessor":"docSubmissionDate"},{"header":"Outstanding","accessor":"outstandingInitial"}];
