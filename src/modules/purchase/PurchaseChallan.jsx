...
export const PurchaseChallan = () => {
  ...
  const handleActionClick = (item) => {
    ...
    autoFields = { challanNumber: 'CHL-' + Math.floor(Math.random()*10000) };
    
    
    
    
    const readOnlyFields = ["prNumber","poNumber","netWeight","totalAmount","netPayable"];
  ...
  const pendingCols = [{"header":"PR Number","accessor":"prNumber"},{"header":"PO Number","accessor":"poNumber"},{"header":"Mandi Name","accessor":"mandiName"},{"header":"Mandi Location","accessor":"mandiLocation"},{"header":"Vehicle Number","accessor":"vehicleNumber"},{"header":"Expected Purchase Date","accessor":"expectedPurchaseDate"}];
  const historyCols = [{"header":"PR Number","accessor":"prNumber"},{"header":"PO Number","accessor":"poNumber"},{"header":"Challan Number","accessor":"challanNumber"},{"header":"Challan Date","accessor":"challanDate"},{"header":"Farmer Name","accessor":"farmerName"},{"header":"Paddy Grade","accessor":"paddyGrade"},{"header":"No. of Bags","accessor":"noOfBags"},{"header":"Gross Weight (Kg)","accessor":"grossWeight"},{"header":"Net Weight (Kg)","accessor":"netWeight"},{"header":"Rate (₹/Qt)","accessor":"rate"},{"header":"Net Payable (₹)","accessor":"netPayable"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 6 - Purchase Challan</h2>
      </div>
      ...
      <Modal 
        ...
        title="Generate Purchase Challan"
      >
