...
export const SourceEntry = () => {
  const getInitialData = () => {
    ...
    const rawPending = JSON.parse(localStorage.getItem('purchase_5_history')) || [];
    const rawHistory = JSON.parse(localStorage.getItem('purchase_6_history')) || [];
  ...
  const handleSave = () => {
    ...
    localStorage.setItem('purchase_6_history', JSON.stringify(rawHistory));
