...
export const MaterialReceipt = () => {
  const getInitialData = () => {
    ...
    const rawPending = JSON.parse(localStorage.getItem('purchase_9_history')) || [];
    const rawHistory = JSON.parse(localStorage.getItem('purchase_10_history')) || [];
  ...
  const handleSave = () => {
    ...
    localStorage.setItem('purchase_10_history', JSON.stringify(rawHistory));
