...
export const POEntry = () => {
  ...
  const handleActionClick = (item) => {
    if ("POEntry" === "FullKitting" && item.approved === 'No') {
    ...
    let autoFields = {};
    if ("POEntry" === "PurchaseApproval") autoFields = { approvalId: "APR-00" + Math.floor(Math.random()*100) };
    if ("POEntry" === "CreatePO") autoFields = { poNumber: "PO-00" + Math.floor(Math.random()*100) };
    if ("POEntry" === "ArrangeLogistics") autoFields = { logisticsId: "LOG-00" + Math.floor(Math.random()*100) };
    if ("POEntry" === "POEntry") autoFields = { poEntryId: "POE-00" + Math.floor(Math.random()*100) };
    if ("POEntry" === "AdvancePayment") autoFields = { advanceId: "ADV-00" + Math.floor(Math.random()*100) };
    if ("POEntry" === "Lift") autoFields = { liftId: "LIFT-00" + Math.floor(Math.random()*100) };
    if ("POEntry" === "LabReport") autoFields = { labReportId: "LAB-00" + Math.floor(Math.random()*100) };
    if ("POEntry" === "FullKitting") autoFields = { kittingId: "FK-00" + Math.floor(Math.random()*100), challanNo: "CHL-00" + Math.floor(Math.random()*100) };
    if ("POEntry" === "PurchaseClosure") autoFields = { closureId: "PC-00" + Math.floor(Math.random()*100), lotNo: "LT-00" + Math.floor(Math.random()*100), batchNo: "BT-00" + Math.floor(Math.random()*100) };
    
    const readOnlyFields = ["poNumber","indentNo","logisticsId","poEntryId"];
  ...
  const actionColumn = {
    ...
    cell: (row) => {
      if ("POEntry" === "FullKitting" && row.approved === 'No') {
        return (
  ...
  const pendingCols = [{"header":"PO Number","accessor":"poNumber"},{"header":"Indent No","accessor":"indentNo"},{"header":"Logistics ID","accessor":"logisticsId"},{"header":"Purchase Type","accessor":"purchaseType"},{"header":"Agency / Vendor Name","accessor":"agencyVendorName"},{"header":"Paddy Grade","accessor":"paddyGrade"},{"header":"Quantity MT","accessor":"qtyMt"},{"header":"Rate ₹/Qt","accessor":"rate"},{"header":"Vehicle Number","accessor":"vehicleNumber"},{"header":"Expected Departure","accessor":"expectedDeparture"}].map(col => {
    if (col.accessor === 'approved' && "POEntry" === "FullKitting") {
      return {
        ...col,
        cell: (row) => (
  ...
  const historyCols = [{"header":"PO Entry ID","accessor":"poEntryId"},{"header":"PO Number","accessor":"poNumber"},{"header":"Indent No","accessor":"indentNo"},{"header":"Entry Date","accessor":"entryDate"},{"header":"Location","accessor":"location"},{"header":"Lot No","accessor":"lotNo"},{"header":"No. of Bags","accessor":"noOfBags"},{"header":"Gross Weight at Source Kg","accessor":"grossWeight"},{"header":"Moisture at Source %","accessor":"moisture"},{"header":"Paddy Grade Verified","accessor":"paddyGradeVerified"},{"header":"Recorded By","accessor":"recordedBy"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 5 - PO Entry</h2>
      </div>
      ...
      >
        <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label>Mandi / Agency Location</Label>
              <Input 
                type="text"
            ...
            <div className="space-y-1.5">
              <Label>Auction Slot / Token No</Label>
              <Input 
                type="text"
            ...
            <div className="space-y-1.5">
              <Label>Gross Weight at Source Kg</Label>
              <Input 
                type="number"
            ...
            <div className="space-y-1.5">
              <Label>Moisture at Source %</Label>
              <Input 
                type="number"
            ...
            <div className="space-y-1.5">
              <Label>Paddy Grade Verified</Label>
              <Input 
                type="text"
