...
export const GrossWeight = () => {
  ...
  const handleActionClick = (item) => {
    ...
    autoFields = { weightSlipNumber: 'WS-' + Math.floor(Math.random()*10000) };
    
    
    const readOnlyFields = ["prNumber","poNumber","gateEntryNumber","challanNumber","netWeight"];
  ...
  const pendingCols = [{"header":"PR Number","accessor":"prNumber"},{"header":"PO Number","accessor":"poNumber"},{"header":"Gate Entry Number","accessor":"gateEntryNumber"},{"header":"Entry Date","accessor":"entryDate"},{"header":"Vehicle Number","accessor":"vehicleNumber"},{"header":"Challan Number","accessor":"challanNumber"},{"header":"Driver Name","accessor":"driverName"}];
  const historyCols = [{"header":"PR Number","accessor":"prNumber"},{"header":"PO Number","accessor":"poNumber"},{"header":"Weight Slip Number","accessor":"weightSlipNumber"},{"header":"Challan Number","accessor":"challanNumber"},{"header":"Gate Entry Number","accessor":"gateEntryNumber"},{"header":"Gross Weight (Kg)","accessor":"grossWeight"},{"header":"Tare Weight (Kg)","accessor":"tareWeight"},{"header":"Net Weight (Kg)","accessor":"netWeight"},{"header":"Weigh Date","accessor":"weighDate"},{"header":"Operator Name","accessor":"operatorName"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 8 - Gross Weight</h2>
      </div>
        ...
        <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input 
                type="time"
                value={formData.weighTime || ''} 
                onChange={(e) => setFormData({...formData, weighTime: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
