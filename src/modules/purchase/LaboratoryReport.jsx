  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Laboratory Report</h1>
          <p className="text-slate-500">Manage laboratory report</p>
        </div>
              ...
              <tr>
                {activeTab === 'pending' ? (
                  ...
                  <>
                    ...
                    <th className="px-6 py-4 font-bold">Indent No</th>
                    <th className="px-6 py-4 font-bold">Lot No</th>
                    <th className="px-6 py-4 font-bold">Lab Name</th>
                    <th className="px-6 py-4 font-bold">Test Date</th>
                    <th className="px-6 py-4 font-bold">Moisture %</th>
                    <th className="px-6 py-4 font-bold">Broken %</th>
                    <th className="px-6 py-4 font-bold">Paddy Grade Result</th>
                    <th className="px-6 py-4 font-bold">Recovery %</th>
                    <th className="px-6 py-4 font-bold">Lab Result</th>
                    <th className="px-6 py-4 font-bold">Approved</th>
                ...
                <>
                  {historyItems.map((item, index) => (
                    <tr key={index} className={getRowClass(item.orderType || item.purchaseType)}>
                      ...
                      <td className="px-6 py-4 font-medium text-slate-700">{getVal(item, 'testDate')}</td>
                      <td className="px-6 py-4 font-medium text-slate-700">{getVal(item, 'moisture')}</td>
                      <td className="px-6 py-4 font-medium text-slate-700">{getVal(item, 'broken')}</td>
                      <td className="px-6 py-4 font-medium text-slate-700">{getVal(item, 'paddyGradeResult')}</td>
                      <td className="px-6 py-4 font-medium text-slate-700">{getVal(item, 'recovery')}</td>
                      <td className="px-6 py-4 font-medium text-slate-700">{getVal(item, 'labResult')}</td>
                      <td className="px-6 py-4 font-medium text-slate-700">{getVal(item, 'approved')}</td>
                      <td className="px-6 py-4 font-medium text-slate-700">{getVal(item, 'technician')}</td>
                    </tr>
                  ))}
      ...
      <Modal 
        ...
        title={`Laboratory Report Details`}
        size="4xl"
      >
        <div className="max-h-[85vh] overflow-y-auto p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <div className="space-y-1">
              <Label className="text-sm font-medium text-slate-700">Lab Report ID</Label>
              <Input 
                type="text"
            ...
            <div className="space-y-1">
              <Label className="text-sm font-medium text-slate-700">Damaged / Discoloured %</Label>
              <Input 
                type="number"
            ...
            <div className="space-y-1">
              <Label className="text-sm font-medium text-slate-700">Paddy Grade Result</Label>
              <Select 
                value={formData.paddyGradeResult || ''} 
                onChange={(e) => setFormData({...formData, paddyGradeResult: e.target.value})}
                disabled={false}
                className={'w-full mt-1.5 bg-white border-slate-300 text-slate-900 focus:ring-blue-500 focus:border-blue-500 rounded-md shadow-sm'}
              >
            ...
            <div className="space-y-1">
              <Label className="text-sm font-medium text-slate-700">Recovery % Expected</Label>
              <Input 
                type="number"
            ...
            <div className="space-y-1">
              <Label className="text-sm font-medium text-slate-700">Lab Technician Name</Label>
              <Input 
                type="text"
            ...
            <div className="space-y-1">
              <Label className="text-sm font-medium text-slate-700">Lab Remarks</Label>
              <Input 
                type="text"
            ...
            <div className="space-y-1">
              <Label className="text-sm font-medium text-slate-700">Lab Result</Label>
              <Select 
            ...
            <div className="space-y-1">
              <Label className="text-sm font-medium text-slate-700">Approved for Receipt</Label>
              <Select 
