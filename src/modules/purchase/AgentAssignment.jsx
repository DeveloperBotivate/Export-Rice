...
export const AgentAssignment = () => {
  ...
  const pendingCols = [{"header":"PR Number","accessor":"prNumber"},{"header":"PO Number","accessor":"poNumber"},{"header":"PO Date","accessor":"poDate"},{"header":"Paddy Grade","accessor":"paddyGrade"},{"header":"Quantity (MT)","accessor":"quantity"},{"header":"Target Mandi","accessor":"targetMandi"},{"header":"Vendor Name","accessor":"vendorName"}];
  const historyCols = [{"header":"PR Number","accessor":"prNumber"},{"header":"PO Number","accessor":"poNumber"},{"header":"Agent Name","accessor":"agentName"},{"header":"Agent ID","accessor":"agentId"},{"header":"Agent Firm Name","accessor":"agentFirmName"},{"header":"Mandi","accessor":"targetMandi"},{"header":"Commission Type","accessor":"commissionType"},{"header":"Commission Rate","accessor":"commissionRate"},{"header":"Assignment Date","accessor":"assignmentDate"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 3 - Agent Assignment</h2>
      </div>
      ...
      >
        <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label>Agent ID / License No</Label>
              <Input 
                type="text"
            ...
            <div className="space-y-1.5">
              ...
              <Input 
                type="text"
                value={formData.agentFirmName || ''} 
                onChange={(e) => setFormData({...formData, agentFirmName: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              >
                ...
                <option value="Per Qt">Per Qt</option><option value="Percentage">Percentage</option>
              </Select>
            </div>
            <div className="space-y-1.5">
