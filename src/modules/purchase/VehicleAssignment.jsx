...
export const VehicleAssignment = () => {
  ...
  const pendingCols = [{"header":"PR Number","accessor":"prNumber"},{"header":"PO Number","accessor":"poNumber"},{"header":"Agent Name","accessor":"agentName"},{"header":"Mandi","accessor":"targetMandi"},{"header":"Quantity (MT)","accessor":"quantity"},{"header":"Assignment Date","accessor":"assignmentDate"}];
  const historyCols = [{"header":"PR Number","accessor":"prNumber"},{"header":"PO Number","accessor":"poNumber"},{"header":"Vehicle Number","accessor":"vehicleNumber"},{"header":"Vehicle Type","accessor":"vehicleType"},{"header":"Driver Name","accessor":"driverName"},{"header":"Driver Phone","accessor":"driverPhone"},{"header":"Vehicle Capacity (MT)","accessor":"vehicleCapacity"},{"header":"Transporter Name","accessor":"transporterName"},{"header":"Expected Departure Date","accessor":"expectedDepartureDate"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 4 - Vehicle Assignment</h2>
      </div>
