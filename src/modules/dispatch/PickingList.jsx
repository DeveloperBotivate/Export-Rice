...
export const PickingList = () => {
  ...
  const handleActionClick = (item) => {
    ...
    autoFields = { pickListNo: 'PK-' + Math.floor(Math.random()*10000), location: item.godown + '/' + item.rackBin };
    ...
    const readOnlyFields = ["reservationId","dispatchOrderNo","pickListNo","warehouse","location","riceGrade","lotNo","batchNo"];
  ...
  const pendingCols = [{"header":"Reservation ID","accessor":"reservationId"},{"header":"Dispatch Order No","accessor":"dispatchOrderNo"},{"header":"Customer Name","accessor":"customerName"},{"header":"Rice Grade","accessor":"riceGrade"},{"header":"Reserved Qty (MT)","accessor":"reservedQty"},{"header":"No. of Bags","accessor":"reservedBags"},{"header":"Lot No","accessor":"lotNo"},{"header":"Batch No","accessor":"batchNo"},{"header":"Warehouse","accessor":"warehouse"},{"header":"Go-down","accessor":"godown"},{"header":"Rack/Bin","accessor":"rackBin"},{"header":"Reservation Date","accessor":"reservationDate"}];
  const historyCols = [{"header":"Pick List No","accessor":"pickListNo"},{"header":"Reservation ID","accessor":"reservationId"},{"header":"Dispatch Order No","accessor":"dispatchOrderNo"},{"header":"Customer Name","accessor":"customerName"},{"header":"Warehouse","accessor":"warehouse"},{"header":"Go-down","accessor":"godown"},{"header":"Rack/Bin","accessor":"rackBin"},{"header":"Rice Grade","accessor":"riceGrade"},{"header":"Lot No","accessor":"lotNo"},{"header":"Batch No","accessor":"batchNo"},{"header":"Picked Qty (MT)","accessor":"pickedQty"},{"header":"No. of Bags","accessor":"pickedBags"},{"header":"Pick Date","accessor":"pickDate"},{"header":"Picked By","accessor":"pickedBy"},{"header":"Supervisor","accessor":"supervisor"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 3 - Picking List</h2>
      </div>
      ...
      >
        <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label>Picker Remarks</Label>
              <Input 
                type="text"
                value={formData.pickerRemarks || ''} 
                onChange={(e) => setFormData({...formData, pickerRemarks: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
