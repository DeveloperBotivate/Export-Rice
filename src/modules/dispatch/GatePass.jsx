...
export const GatePass = () => {
  ...
  const handleActionClick = (item) => {
    ...
    autoFields = { gatePassNo: 'GP-' + Math.floor(Math.random()*10000), invoiceRef: item.invoiceNo, challanRef: item.challanNo };
    
    
    
    
    const readOnlyFields = ["invoiceNo","dispatchOrderNo","gatePassNo","vehicleNumber","driverName","driverPhone","invoiceRef","challanRef"];
  ...
  const pendingCols = [{"header":"Invoice No","accessor":"invoiceNo"},{"header":"Dispatch Order No","accessor":"dispatchOrderNo"},{"header":"Customer Name","accessor":"customerName"},{"header":"Vehicle Number","accessor":"vehicleNumber"},{"header":"Driver Name","accessor":"driverName"},{"header":"Grand Total (₹)","accessor":"grandTotal"},{"header":"Invoice Date","accessor":"invoiceDate"},{"header":"Payment Due Date","accessor":"paymentDueDate"}];
  const historyCols = [{"header":"Gate Pass No","accessor":"gatePassNo"},{"header":"Invoice No","accessor":"invoiceNo"},{"header":"Dispatch Order No","accessor":"dispatchOrderNo"},{"header":"Issue Date & Time","accessor":"issueDate"},{"header":"Vehicle No","accessor":"vehicleNumber"},{"header":"Driver Name","accessor":"driverName"},{"header":"No. of Bags","accessor":"noOfBags"},{"header":"Net Weight (Kg)","accessor":"netWeight"},{"header":"Destination","accessor":"destination"},{"header":"Gate","accessor":"gateNo"},{"header":"Security Guard Name","accessor":"guardName"},{"header":"Issued By","accessor":"issuedBy"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 9 - Gate Pass</h2>
      </div>
        ...
        <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input 
                type="text"
                value={formData.challanRef || ''} 
                onChange={(e) => setFormData({...formData, challanRef: e.target.value})}
                readOnly={true}
                className={true ? 'bg-slate-100' : ''}
              />
            </div>
            ...
            <div className="space-y-1.5">
              <Label>Gate (Exit Gate No)</Label>
              <Input 
                type="text"
                value={formData.gateNo || ''} 
                onChange={(e) => setFormData({...formData, gateNo: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
