...
export const EWayBill = () => {
  ...
  const handleActionClick = (item) => {
    ...
    autoFields = { ewbNo: 'EWB-' + Math.floor(Math.random()*10000), invoiceRef: item.invoiceNo, taxableValue: item.basicAmount, gstAmount: item.cgst + item.sgst + item.igst, grandTotal: item.grandTotal };
    
    
    
    const readOnlyFields = ["gatePassNo","invoiceNo","dispatchOrderNo","ewbNo","validTill","customerGst","invoiceRef","hsnCode","taxableValue","gstAmount","grandTotal","vehicleNumber"];
  ...
  const pendingCols = [{"header":"Gate Pass No","accessor":"gatePassNo"},{"header":"Invoice No","accessor":"invoiceNo"},{"header":"Dispatch Order No","accessor":"dispatchOrderNo"},{"header":"Customer Name","accessor":"customerName"},{"header":"Customer GSTIN","accessor":"customerGst"},{"header":"Vehicle Number","accessor":"vehicleNumber"},{"header":"Grand Total (₹)","accessor":"grandTotal"},{"header":"Issue Date","accessor":"issueDate"}];
  const historyCols = [{"header":"EWB No","accessor":"ewbNo"},{"header":"Gate Pass No","accessor":"gatePassNo"},{"header":"Invoice No","accessor":"invoiceNo"},{"header":"Dispatch Order No","accessor":"dispatchOrderNo"},{"header":"Customer Name","accessor":"customerName"},{"header":"Customer GSTIN","accessor":"customerGst"},{"header":"EWB Date","accessor":"ewbDate"},{"header":"Valid Till","accessor":"validTill"},{"header":"Total Value (₹)","accessor":"totalValue"},{"header":"Distance (km)","accessor":"distance"},{"header":"Mode of Transport","accessor":"modeOfTransport"},{"header":"Transporter ID","accessor":"transporterId"},{"header":"Generated By","accessor":"generatedBy"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 10 - E-Way Bill</h2>
      </div>
      ...
      >
        <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label>GSTIN Supplier</Label>
              <Input 
                type="text"
                value={formData.supplierGst || ''} 
                onChange={(e) => setFormData({...formData, supplierGst: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
            <div className="space-y-1.5">
              <Label>GSTIN Recipient</Label>
              <Input 
                type="text"
            ...
            <div className="space-y-1.5">
              <Label>Part B Updated (Y/N)</Label>
              <Select 
                value={formData.partBUpdated || ''} 
                onChange={(e) => setFormData({...formData, partBUpdated: e.target.value})}
                disabled={false}
                className={false ? 'bg-slate-100' : ''}
              >
                <option value="">Select Part B Updated (Y/N)</option>
