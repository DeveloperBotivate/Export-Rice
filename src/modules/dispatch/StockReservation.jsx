...
export const StockReservation = () => {
  ...
  const handleActionClick = (item) => {
    ...
    let autoFields = {};
    autoFields = { reservationId: 'SR-' + Math.floor(Math.random()*10000) };
    ...
    const readOnlyFields = ["dispatchOrderNo","reservationId","riceGrade"];
  ...
  const pendingCols = [{"header":"Dispatch Order No","accessor":"dispatchOrderNo"},{"header":"Order Date","accessor":"orderDate"},{"header":"Order Type","accessor":"orderType"},{"header":"Customer Name","accessor":"customerName"},{"header":"Rice Grade","accessor":"riceGrade"},{"header":"Quantity (MT)","accessor":"quantity"},{"header":"No. of Bags","accessor":"noOfBags"},{"header":"Required Dispatch Date","accessor":"reqDispatchDate"},{"header":"Priority","accessor":"priority"}];
  const historyCols = [{"header":"Reservation ID","accessor":"reservationId"},{"header":"Dispatch Order No","accessor":"dispatchOrderNo"},{"header":"Customer Name","accessor":"customerName"},{"header":"FG Stock ID","accessor":"fgStockId"},{"header":"Rice Grade","accessor":"riceGrade"},{"header":"Lot No","accessor":"lotNo"},{"header":"Batch No","accessor":"batchNo"},{"header":"Reserved Qty (MT)","accessor":"reservedQty"},{"header":"No. of Bags","accessor":"reservedBags"},{"header":"Warehouse","accessor":"warehouse"},{"header":"Go-down","accessor":"godown"},{"header":"Rack/Bin","accessor":"rackBin"},{"header":"Reservation Date","accessor":"reservationDate"},{"header":"Reserved By","accessor":"reservedBy"}];
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 2 - Stock Reservation</h2>
      </div>
      ...
      >
        <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label>Available Stock (MT)</Label>
              <Input 
                type="number"
            ...
            <div className="space-y-1.5">
              <Label>Reserved Quantity (MT)</Label>
              <Input 
                type="number"
            ...
            <div className="space-y-1.5">
              <Label>No. of Bags Reserved</Label>
              <Input 
                type="number"
                value={formData.reservedBags || ''} 
                onChange={(e) => setFormData({...formData, reservedBags: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
            ...
            <div className="space-y-1.5">
              <Label>Expiry/FEFO Date</Label>
              <Input 
                type="date"
                value={formData.fefoDate || ''} 
                onChange={(e) => setFormData({...formData, fefoDate: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
