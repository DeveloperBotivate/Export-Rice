...
export const SentQuotation = () => {
  ...
  const handleActionClick = (item) => {
    ...
    let autoFields = {};
    autoFields = { quotationNo: 'QT-' + Math.floor(Math.random()*10000) };
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800">Stage 2 - Sent Quotation</h2>
      </div>
        ...
        <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input 
                type="text"
                value={formData.riceGradeRequired || ''} 
                onChange={(e) => setFormData({...formData, riceGradeRequired: e.target.value})}
                readOnly={true}
                className={true ? 'bg-slate-100' : ''}
              />
            </div>
            <div className="space-y-1.5">
              ...
              <Input 
                type="number"
                value={formData.quotedQty || ''} 
                onChange={(e) => setFormData({...formData, quotedQty: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
            <div className="space-y-1.5">
              <Label>Price (₹/MT or $/MT for Export)</Label>
              <Input 
                type="number"
            ...
            <div className="space-y-1.5">
              ...
              >
                ...
                <option value="Advance">Advance</option><option value="Net 15">Net 15</option><option value="Net 30">Net 30</option><option value="Net 60">Net 60</option>
              </Select>
            </div>
            <div className="space-y-1.5">
              <Label>Delivery Terms (FOB / CIF / Ex-Mill)</Label>
              <Select 
                ...
                className={false ? 'bg-slate-100' : ''}
              >
                <option value="">Select Delivery Terms (FOB / CIF / Ex-Mill)</option>
                <option value="FOB">FOB</option><option value="CIF">CIF</option><option value="Ex-Mill">Ex-Mill</option>
              </Select>
            </div>
            <div className="space-y-1.5">
            ...
            <div className="space-y-1.5">
              ...
              <Input 
                ...
                onChange={(e) => setFormData({...formData, quotationBy: e.target.value})}
                readOnly={false}
                className={false ? 'bg-slate-100' : ''}
              />
            </div>
